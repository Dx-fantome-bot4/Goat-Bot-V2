...
module.exports = {
	...
	langs: {
		...
		en: {
			missingMessage: "saisir le message que vous souhaitez envoyer à tous les groupes...🖤",
			notification: "📨Notification de mon pudding  à tous les groupes de discussion 📨\n 🖤(Pour répondre, utilisez la cmd『🖤callad』)🖤",
